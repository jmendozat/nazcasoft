...
import controlador.venta.GestionarVentaComando;
 ...
 */
public class GestionarVentaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String url = gestionarVentaComando.ejecutar(request, response);
