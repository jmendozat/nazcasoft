            ...
            <table class="table shoping-cart-table">
                <tbody>
                    <tr>
                        ...
                        <td class="desc">
                            <h3>
                                <% if (plato.getEstado().equals("EN CARTA")){ %>
                                <a href="#" class="text-navy">
                                    <%=plato.getNombre()%> <span id="estadoPlato<%=plato.getPlatoid()%>"  class="label label-info"><%= plato.getEstado()%></span>
                                </a>

                                <%} else if (plato.getEstado().equals("POR AGOTARCE")){%>
                                <a href="#" class="text-navy">
                                    <%=plato.getNombre()%> <span id="estadoPlato<%=plato.getPlatoid()%>" class="label label-warning"><%= plato.getEstado()%></span>
                                </a>
                                <%} else{ %>
                                <a href="#" class="text-navy">
                                    <%=plato.getNombre()%> <span id="estadoPlato<%=plato.getPlatoid()%>"  class="label label-danger"><%= plato.getEstado()%></span>
                                </a>
                                <% } %>
                            </h3>
