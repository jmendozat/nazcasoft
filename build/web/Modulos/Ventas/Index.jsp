...
<html>
    <head>
        ...
        <script src="Modulos/Ventas/js/jsFunc_Ventas.js" type="text/javascript"></script>
    </head>
    <body>
        <div class="row">
            <div class="col-sm-8">
                <div class="ibox">
                    <div class="ibox-content">
                        <h2>Realizar Pago</h2>
                        <p>
                            Solo busca las mesas que estan ocupadas para generarle la boleta o recibo.
                        </p>
        ...
        <div class="modal inmodal fade" id="idModalPagos" tabindex="-1" role="dialog" aria-hidden="true">
