...
<html>
    ...
    <body>
        ...
        <hr>
        <div align="center">
            <form name="FormEditarPlato" id="FormEditarPlato" action="ModificarPlato"> 
                ...
                <table border="1" style="background: aliceblue">
                    <caption><h3>EDITAR PLATO</h3></caption>                    
                    <tfoot>
                        <tr>
                            <th colspan="2">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" id="nombre" name="nombre" value="<%= plato.getNombre() %>" maxlength="40" size="60" required="required" autofocus="autofocus"/></td>
                        </tr>
                        <tr>
                            <td><label for="precio">Precio:</label></td>
                            <td><input type="text" id="precio" name="precio" value="<%= plato.getPrecio() %>" style="text-align: right" maxlength="6" size="10" required="required"/></td>
                        </tr>
                    </tbody>
                </table>                                           
            </form> 
