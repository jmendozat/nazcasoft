...
<%
    ...
    int cantRegistros = listaPlatos.size();
    int cantFilas = cantRegistros / 4;
    int continicial = 0, contfinal = 4;
    for (int i = 0; i < cantFilas; i++) {

%>
<div class="row">

    <%        for (Plato plato : listaPlatos.subList(continicial, contfinal)) {
    %>
    <div class="col-md-3">
        <div class="ibox">
...
<%
        continicial = continicial + 4;
        contfinal = contfinal + 4;
    }
%>
